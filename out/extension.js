...
function activate(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('extension.mono-debug.startSession', function (config) { return startSession(config); }));
}
 ...
 */
var StartSessionResult = /** @class */ (function () {
